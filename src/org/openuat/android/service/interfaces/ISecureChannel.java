 ...
 * receive-callback the receive method of this interface won't work -
 * furthermore using it may cause unpredictable behavior.
 * 
...
public interface ISecureChannel extends android.os.IInterface {
	...
	public static abstract class Stub extends android.os.Binder implements
		...
		private static class Proxy implements
			...
			/**
			 * Blocking receive of data from the other device. Do not use this
			 * method if you registered a receive-callback!
			 * 
			 ...
			 * As long as a callback is registered do not use the
			 * receive-method!
			 * 
			 * @param receiver
			 *            The interface to be called when data is received.
			 */
			...
			/**
			 * Unregister a receive-callback. When all callbacks are
			 * unregistered you can use the receive-method again.
			 * 
			 * @param receiver
			 *            The interface to unregister.
			 */
	...
	/**
	 * Blocking receive of data from the other device. Do not use this method if
	 * you registered a receive-callback!
	 * 
	 * @return a byte-array received recently.
	 */
	public byte[] receive() throws android.os.RemoteException;
	...
	/**
	 * Register for asynchronously receiving data from the other device. As long
	 * as a callback is registered do not use the receive-method!
	 * 
	 * @param receiver
	 *            The interface to be called when data is received.
	 */
	...
	/**
	 * Unregister a receive-callback. When all callbacks are unregistered you
	 * can use the receive-method again.
	 * 
	 * @param receiver
	 *            The interface to unregister.
	 */
