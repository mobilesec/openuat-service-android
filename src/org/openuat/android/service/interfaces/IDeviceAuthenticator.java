...
public interface IDeviceAuthenticator extends android.os.IInterface {
	...
	private static class Proxy implements
	    ...
	    // ISecureChannel connect(in String device, in String
	     ...
	     * authenticated) connection to a device selected by the user. I.e.,
	     * the service will ask the user to select the appropriate device
	     * and perform human-assisted device authentication.
	     * 
	     * On success, an instance of ISecureChannel is returned. On
	     * failure, null is returned.
	     */
	    public org.openuat.android.service.interfaces.ISecureChannel selectAndAuthenticate(
		    java.lang.String serviceId)
		    throws android.os.RemoteException {
		android.os.Parcel _data = android.os.Parcel.obtain();
		android.os.Parcel _reply = android.os.Parcel.obtain();
		...
		try {
		    _data.writeInterfaceToken(DESCRIPTOR);
		    _data.writeString(serviceId);
		    mRemote.transact(Stub.TRANSACTION_selectAndAuthenticate,
			    _data, _reply, 0);
		    _reply.readException();
	     ...
	     * human-assisted device authentication.
	     * 
	     * On success, an instance of ISecureChannel is returned. On
	     * failure, null is returned.
	     */
	...
	static final int TRANSACTION_selectAndAuthenticate = (android.os.IBinder.FIRST_CALL_TRANSACTION + 4);
     ...
     */
    public org.openuat.android.service.interfaces.ISecureChannel selectAndAuthenticate(
	    java.lang.String serviceId) throws android.os.RemoteException;
     ...
     * service will perform human-assisted device authentication.
     * 
     * On success, an instance of ISecureChannel is returned. On failure, null
     * is returned.
     */
